...
# We can compare variables using the symbols above. Take the following variables for example:
my_age = 28
your_age = 30
...
# TASK 1: Create two variables in irb. Compare them using the comparision operators to return true or false.
